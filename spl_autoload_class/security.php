...
$user_panel = new Interface_admin();
$interface->head();
if(isset($_SESSION["user_email"]) && isset($_SESSION["user_id"])){
$interface->sidebar();
$interface->top_menu();
$sold = new Sold_View();
$info_user = new UserView();
$sold_id = $sold->view_all_sold_product();
$info = $info_user->return_user_info();
$cart = new Shop_View();
$cart->get_delete_shopID();
$cart->get_update_q();

include_once(__DIR__."../../components/user_payment_component.php");
$interface->footer();
}else{
	echo "you don't have permission";
}
...
include_once(__DIR__."../../components/user_bought_component.php");
$interface->footer();
}else{
	echo "you don't have permission";
}
...
include_once(__DIR__."../../components/user_change_pass_component.php");
$interface->footer();
}else{
	echo "you don't have permission";
} }
